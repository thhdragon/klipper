...
class ProbePointsHelper:
    ...
    def update_default_points(self, points):
        self.probe_points = points
        # It's possible this is called before minimum_points, so don't validate
        # until the user explicitly calls minimum_points.
    def update_default_points(self, points):
        self.probe_points = points
